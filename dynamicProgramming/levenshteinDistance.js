...
there are 3 edit operations: insertion of a char, deletion of a char, and sub of a char
for another

Sample Input
"str1": "abc", "str2": "yabd"
Output
2 // insert "y" sub "c" for "d"
*/
...
levenshteinDistance = (str1, str2) =>{
    ...
    // console.log(edits)
    return coins[str2.length][str1.length]
}

levenshteinDistance2 =(str1, str2) =>{
