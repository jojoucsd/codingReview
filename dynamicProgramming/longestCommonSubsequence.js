...
a subsequence of a string is a set of chars that asren't necessarily adjacent in the
string but that are in the same order as they appear in the string.
