...
naively be encoded as "12A", since this string can be decoded as either "AAAAAAAAAAAA" or "1AA". Thus, long runs(runs of 10 or more characters)
...
const inputStr = "AAAAAAAAAAAAABBCCCCDD"


runLengthEncodingSolution = (str) =>{
    const result = []
...
console.log(runLengthEncodingSolution(inputStr))
